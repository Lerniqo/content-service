...
export class ConceptsController {
  ...
  async create(
    ...
    LoggerUtil.logInfo(this.logger, 'ConceptsController', 'Creating concept', {
    ...
    try {
      const result = await this.conceptsService.createConcept(
        createConceptDto,
        adminId,
      );
  ...
  @ApiOperation({
    ...
    description:
      'Updates an existing concept with new data. Admin role required.',
  })
  @ApiParam({
    name: 'id',
  ...
  async update(
    ...
    LoggerUtil.logInfo(this.logger, 'ConceptsController', 'Updating concept', {
      conceptId: id,
  ...
  @ApiOperation({
    ...
    description:
      'Creates a HAS_PREREQUISITE relationship from one concept to another. Admin role required.',
  })
  @ApiParam({
    name: 'id',
    description:
      'The unique identifier of the concept that will have the prerequisite',
    example: 'concept-123',
  })
  @ApiBody({
